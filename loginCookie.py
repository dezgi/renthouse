    ...
    <h2>New Advertisement</h2>
            <div class="form-container tableBox">
                <form action="post.py" method="post">
                    ...
                    <input type="text" placeholder="Street"  name="position"/>
                    <input type="text" placeholder="City" name="description"/>
                    <input type="text" placeholder="Number of Bedrooms" name="expectation"/>
                    <input type="text" placeholder="Monthly Fee" name="deadline"/>
